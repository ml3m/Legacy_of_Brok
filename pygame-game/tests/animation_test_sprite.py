...
image_sprite = [pygame.image.load("Legacy_of_Brok/pygame- game/tests/assets/Sprite1.png"),
                pygame.image.load("Legacy_of_Brok/pygame- game/tests/assets/Sprite2.png")]
